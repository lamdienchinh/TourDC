...
const Error = () => {
    const rowSvgRef = useRef(null);
    const zeroSvgRef = useRef(null);
    useEffect(() => {
        // Animation for .row svg
        anime({
            targets: rowSvgRef.current,
            translateY: 10,
            autoplay: true,
            loop: true,
